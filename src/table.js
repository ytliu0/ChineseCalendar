...
function printWarningMessage(y, langCon) {
    ...
    if (y==1670 && langCon.region != 'SouthernMing') {
        if (lang==0) {
            ...
            warn = '<p style="color:red;">康熙元年正月初一本在丙子日(2月19日)，事緣順治十八年閏七年，當年十一月含冬至和大寒兩中氣，雨水本來定在十二月晦，但這使康熙元年正月不含中氣。為免遭人非議，欽天監將正月初一提前一日至乙亥日(2月18日)，使正月含雨水，無中氣月便移到十二月。</p>';
        } else {
            warn = '<p style="color:red;">康熙元年正月初一本在丙子日(2月19日)，事缘顺治十八年闰七年，当年十一月含冬至和大寒两中气，雨水本来定在十二月晦，但这使康熙元年正月不含中气。为免遭人非议，钦天监将正月初一提前一日至乙亥日(2月18日)，使正月含雨水，无中气月便移到十二月。</p>';
        }
    }
